...
<head>
    ...
    <script src="${pageContext.request.contextPath }/admin/js/shelf.js"></script>
    <script>
        $(function(){
            $('img').jqthumb({
                width: 70,
...
<body>
    <div class="search">
        <form action="${pageContext.request.contextPath }/adminProduct_downPage.action" id="searchForm" name="searchForm" method="get">
            <input type="text" name="keyword" />
            <a>查询</a>
        </form>    
        <div class="findAll">
            <a href="${pageContext.request.contextPath }/adminProduct_downPage.action">所有商品</a>
    ...
    <div class="product">
        ...
        <ul class="proContent">
                ...
                <div class="pagination">
                    <div class="pageInner">
                        ...
                        <s:if test="pageBean.page!=1">
                            <a href="${pageContext.request.contextPath }/adminProduct_downPage.action?page=1" class="first">首页</a>
                            <a href="${pageContext.request.contextPath }/adminProduct_downPage.action?page=<s:property value="pageBean.page-1"/>" class="pre">上一页</a>
                        </s:if>
                        <s:else>
                        ...
                        <s:if test="pageBean.totalPage<=3">
                            <s:iterator begin="1" end="pageBean.totalPage" step="1" var="ps">
                                ...
                                <s:else>
                                    <a href="${pageContext.request.contextPath }/adminProduct_downPage.action?&page=<s:property value="#ps"/>"><s:property value="#ps"/></a>
                                </s:else>
                            </s:iterator>
                        </s:if>
                        ...
                        <s:if test="pageBean.totalPage!=page">
                            <a href="${pageContext.request.contextPath }/adminProduct_downPage.action?page=<s:property value="pageBean.page+1"/>" class="next">下一页</a>
                            <a href="${pageContext.request.contextPath }/adminProduct_downPage.action?page=<s:property value="pageBean.totalPage"/>" class="last">末页</a>
                        </s:if>
                        <s:else>
            ...
            <s:else>
                <li style="border-bottom: none;text-align:center;line-height:70px" id="noRecord">没有该商品记录！</li>
            </s:else>
