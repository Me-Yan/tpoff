...
<body>
    ...
    <div class="center">
        <span>恭喜您成功激活账号，请前去登录账号！<span class="time">5</span>秒后自动跳转到登录页面！</span><a href="${pageContext.request.contextPath }/user_loginPage.action">点我立即跳转</a>
    </div>
